function []=Extract_missing_dates(input_file)
warning ('off','all');
output_file='Error_outputs/Ref_with_missing_dates.txt';
...
fclose(fid);
fclose(out);
disp([num2str(counter), ' references scanned, ', num2str(match), ' missing dates found !']);
